...
function sendMsg() {
  ...
  if (msg[3] || msg[4]) {
    ...
    sendMessageBox.value!.setAttribute('placeholder', 'Void content!!!!!!!!!!!!!!') //*This line of code sets the placeholder attribute of the element with the ID "sendMessageBox" to display a message indicating that the content should not be empty.
  }
}
function getMyName() {
  if (MyName) {
